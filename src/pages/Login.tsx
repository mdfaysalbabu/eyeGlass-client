...
const Login = () => {
  ...
  return (
    <div className="container mx-auto">
      <div className="w-full  mx-auto lg:w-[500px] drop-shadow-lg bg-teal-200 h-screen  overflow-hidden  items-center justify-center">
        <div className="md:mt-6 mt-48">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className=" md:p-18 p-12">
          <div className="space-y-6">
            ...
            <div className="relative">
              <input
                ...
                type="password"
                id="password"
                className="bg-white rounded pl-12 py-2 md:py-4 focus:outline-none w-full"
          ...
          <button className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded mt-5">
            Login
          </button>
          <div className="mt-4">
