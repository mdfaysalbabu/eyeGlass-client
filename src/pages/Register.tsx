...
const Register = () => {
  ...
  return (
    <div className="container mx-auto">
      <div className="w-full max-w-md p-10 space-y-3 rounded-xl border b  font-sans mx-auto lg:w-[500px] drop-shadow-lg bg-teal-200 h-screen overflow-hidden  items-center justify-center  ">
